    ...
    public partial class QC_inprocess : System.Web.UI.Page
    {
        ...
        {            
            ...
            {                
                ...
                if (json != null)
                {
                    ...
                    {
                        sampling_lab.Text = (Convert.ToDouble(json.Sampling) * 100) + "%";
                        double s = Math.Round((Convert.ToDouble(json.Sampling) * Convert.ToDouble(json.Qty)), 0);
                        sampling_qty_lab.Text = s.ToString();
                        if(Convert.ToDouble(json.Sampling) != 1)
        ...
        protected void vali_btn_Click(object sender, EventArgs e)
        {
            ...
            if (item_relation == 0)
            {
                ...
                str = "update qc_temp_searchlist set Item = " + i + " where Id = " + id + ";";
