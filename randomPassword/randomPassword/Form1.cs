...
namespace randomPassword
{
    public partial class Form1 : Form
    {
        ...
        {
            textBox1.Text = GetRandomFirstTittle(1) + GetRandomSendtoForth(3) + GetRandomSendFinalNum(4) + Environment.NewLine; 
            textBox1.Text += GetRandomFirstTittle(1) + GetRandomSendtoForth(3) + GetRandomSendFinalNum(4) + Environment.NewLine; 
            textBox1.Text += GetRandomFirstTittle(1) + GetRandomSendtoForth(3) + GetRandomSendFinalNum(4) + Environment.NewLine; 
            textBox1.Text += GetRandomFirstTittle(1) + GetRandomSendtoForth(3) + GetRandomSendFinalNum(4) + Environment.NewLine;
            textBox1.Text += GetRandomFirstTittle(1) + GetRandomSendtoForth(3) + GetRandomSendFinalNum(4);
