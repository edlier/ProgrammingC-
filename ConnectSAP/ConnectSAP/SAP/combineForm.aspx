    ...
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="grid_CbineLst" runat="server" AutoGenerateColumns="false">
            <Columns>
                ...
                <asp:BoundField DataField="LackMaterial" HeaderText="缺料數量(需求-WH+QC*2)" DataFormatString="{0:0.##}"/>
                ...
                <asp:BoundField DataField="BdAMult" HeaderText="(B/A)*30" DataFormatString="{0:F}"/>
